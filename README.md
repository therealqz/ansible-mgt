...
Read the README.md file, and edit roles configuration to use correct credentials for MySQL required for the devops-tooling website I created earlier.
...
You can choose to develop your own roles, or find available ones from the community
...
`env-vars\uat.yml`  file to define which loadbalancer to use in UAT environment by setting respective environmental variable to true.
